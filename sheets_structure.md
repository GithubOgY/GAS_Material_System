...
新しいスプレッドシートを作成し、以下の5つのシート（タブ）を、指定された名前と列で作成してください。
...
| A列 | B列 | C列 | D列 | E列 | F列 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **OrderID** | **Date** | **ClientName** | **ProductID** | **Quantity** | **Status** |
| (受注ID) | (日付) | (顧客名) | (商品ID) | (数量) | (状態) |
| PO-2001 | 2023-11-05 | Client A | P001 | 1 | Delivered |
...
**注意**: `Product_Orders`シートにG列（Manufacturer）を追加してください。
| A列 | B列 | C列 | D列 | E列 | F列 | G列 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **OrderID** | **Date** | **ClientName** | **ProductID** | **Quantity** | **Status** | **Manufacturer** |
| (受注ID) | (日付) | (顧客名) | (商品ID) | (数量) | (状態) | (製造業者) |
